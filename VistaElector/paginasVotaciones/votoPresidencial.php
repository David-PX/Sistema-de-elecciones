...
<div class="container-votos mt-4 ">
    <?php for ($i = 0; $i < sizeof($Candidatos); $i++): ?>
        ...
        <button class="btn candidato m-2" id="<?php echo "?puesto=Presidente&partido=" . $Candidatos[$i]['Partido'] . "&voto=1&fecha=" . $hoy . "&nombre=" . $Candidatos[$i]['Nombre']; ?>" >
    ...
    <button class="btn candidato" id="?puesto=Presidente&partido=ninguno&voto=1&fecha=<?php echo $hoy . "&nombre=ninguno";
?>" >
                <div class="card" style="width: 18rem; ">
...
<a href="#" class=" btn btn-success btn-block disabled text-center " id="voto" name='voto' value="1" >Votar</a>
</form>
</div>
