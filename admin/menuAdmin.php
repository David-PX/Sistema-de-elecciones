...
<div class="d-flex" id="content-wrapper">
    ...
    <div id="sidebar-container" class="bg-white border-right border-success">
      ...
      <div class="menu list-group-flush">
        ...
        <a href="../puestosElectivos/vistas/addPuestoElectivo.php" class="list-group-item list-group-item-action text-success bg-white p-3 border-0"><i class="fas fa-user"></i> Puestos Electivos</a>
        <a href="../candidatos/vistas/addCandidato.php" class="list-group-item list-group-item-action text-success bg-white p-3 border-0"><i class="fas fa-chair"></i>Puestos Electivos</a>
